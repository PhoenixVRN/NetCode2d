...
{
    public class CustomPromulTransport : NetworkTransport
    {
        ...
        protected bool ConnectToRelayServer(string joinCode)
        {
            _ = Task.Run(async () =>
            {
        ...
        {
            Debug.Log($"StartClient name Room {NameRoom}");
            m_HostType = HostType.Client;
            return ConnectToRelayServer(NameRoom);
        }

        public override bool StartServer()
        {
            Debug.Log($"StartServer name Room {NameRoom}");
